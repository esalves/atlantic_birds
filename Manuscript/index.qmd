...
![Sampling localities of the 68 passerine species across the Brazilian Atlantic Forest, shown separately for the early (1990–2006) and late (2013–2018) periods of the record, coloured by wing length.](images/fig-map.png){#fig-map}
...
![Wing length of Atlantic Forest passerines against year of sampling, 1990–2018. Shading shows the density of individual records (log scale); the line is the model-estimated population trend with its 95% interval (standardized year effect β = −0.66 mm per SD-year, 95% CI [−1.05, −0.28], Rubin-pooled across 50 trees).](images/fig-wingtrend.png){#fig-wingtrend}
...
If body-size change in these largely insectivorous birds is mediated by food rather than temperature, the abundance of their invertebrate prey should have declined over the study period. Using the PREDICTS database [@hudson2017database], we modelled the abundance of Insecta and Arachnida recorded across South America with negative-binomial models that included sampling effort as an offset (Methods). Arthropod abundance declined markedly with time (standardized year effect β = −0.25, 95% CrI −0.29 to −0.22; N = 76,471 records), equivalent to a multiplicative change of 0.78 (95% CrI 0.75 to 0.80) per standard-deviation increase in year (@fig-arthropods). Because Atlantic Forest passerines are not known to depredate ants, we repeated the analysis excluding Formicidae, which strengthened the decline (β = −0.47, 95% CrI −0.53 to −0.41; multiplicative 0.62 per SD-year; N = 46,505); restricting further to forested biomes gave a near-identical result (β = −0.49, 95% CrI −0.55 to −0.43; N = 45,079; @fig-arthropods). The decline in arthropod prey is therefore robust to the exclusion of ants and of open-habitat records.

![Abundance of forest Insecta and Arachnida in the PREDICTS database across South America against time, excluding ants (Formicidae) and open biomes, with the fitted negative-binomial trend and 95% credible interval. *Placeholder pending regeneration from the analysis.*](images/fig-arthropods.png){#fig-arthropods}
