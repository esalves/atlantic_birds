...
The primary morphological signature — shortening wings alongside invariant body mass — carries profound biomechanical and ecological implications. In flight mechanics, shortening wings without a concomitant reduction in mass inevitably increases wing loading ($M / S$, mass per unit wing area) and shifts wing shape [@norberg1990vertebrate; @pennycuick2008modelling]. This contrasts with patterns documented in intact Amazonian rainforest, where birds reduced body mass while lengthening wings, thereby lowering wing loading in what was interpreted as an adaptation for greater flight efficiency under warming [@jirinec2021morphological]. In the Atlantic Forest, elevated wing loading increases minimum power speed and elevates the energetic cost of sustained cruising flight [@norberg1990vertebrate; @pennycuick2008modelling]. Although shorter or more rounded wings may confer localized advantages in flight maneuverability within cluttered understorey vegetation, the heightened energetic penalty on long-distance flight has severe consequences in fragmented landscapes. The Brazilian Atlantic Forest is among the most fragmented tropical biomes globally, with over 80% of remaining patches smaller than 50 ha and separated by hostile agricultural or pastoral matrices [@ribeiro2009atlantic]. Increased wing loading could directly curtail matrix permeability and dispersal capacity (*gap-crossing ability*), worsening demographic isolation and reducing gene flow between isolated forest remnants.

A second central finding of our study is the steady decadal rise in among-individual phenotypic variability of wing length ($\ln\text{CVR} > 0$), which was explicitly reproduced as a positive residual standard-deviation slope in our causal model ($\sigma$ path = +`r .dpath(drm_f, "scaled_yr", "wing_length", "sigma")`) and linked to thermal extremes. From an evolutionary perspective, rising phenotypic variance under environmental change can reflect either the disruption of developmental buffering or divergent selection across heterogeneous environments. Chronic heat stress and nutritional deficits during altricial nestling growth and post-juvenile moult can overwhelm developmental canalization, generating developmental instability and inflated phenotypic noise [@waddington1942canalization; @debat2001mapping]. Concurrently, forest fragmentation severely disrupts microclimate buffering in tropical forests [@ewers2013fragmentation]: while deep interior forest maintains cool, humid microrefugia, forest edges experience severe thermal spikes and vapor-pressure deficits. Individuals fledging across this fine-scale microclimatic mosaic may express divergent plastic phenotypes, driving up population-level variance. Whether this expanded variance provides the raw phenotypic substrate for rapid adaptive evolution ("evolutionary rescue") or represents an accumulation of maladaptive developmental stress remains an essential empirical question.

The diet-interaction analysis further complicates a simple food-limitation interpretation. The temporal decline in wing length was not steeper in species most reliant on invertebrate prey; if anything it was weaker, with less insectivorous species declining more. This argues against a direct, diet-mediated pathway from arthropod scarcity to body-size loss, and the distributional causal model made the same point explicitly: arthropod abundance, though declining steeply, had no direct effect on wing length, while the rising among-individual variance was reproduced under the causal graph (@fig-drmsem). A more likely reconciliation is that both the arthropod decline and the morphological change are downstream consequences of the same regional warming, rather than standing in a direct cause-and-effect relationship: temperature shapes body size through thermoregulatory mechanisms consistent with Bergmann's rule, while simultaneously suppressing arthropod populations through independent phenological and metabolic pathways [@gardner_declining_2011; @dirzo2014defaunation]. Strictly insectivorous species may additionally buffer size loss through behavioural compensation — increased foraging effort or prey switching — in ways that facultative omnivores and frugivores cannot [@robb2008food].
